      ...
      <div className='container' id="container">
        ...
        <div className='header'>
          <div className='flex justify-content-between'>
            ...
            {/* navbar */}
            <div className='res'>
              <div className='navbar flex alige-item-center justify-content-evenly mt-3 navarr cursor-pointer'>
                ...
                <AnchorLink href="#product" className='no-underline text-white' ><div className='home' >Blog</div></AnchorLink>
              </div>
            </div>
            <div className='menu'>
