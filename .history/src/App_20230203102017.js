          ...
          <div className='flex justify-content-between'>
            ...
            <div className='res'>
              <div className='navbar flex alige-item-center justify-content-evenly'>
                ...
                {pathname === "/" ?
                  <AnchorLink href="#about" className='no-underline text-white'><div className='no-underline text-white'>{nav[1]}</div></AnchorLink>
                  :
                  <div onClick={() => scrollToPage('about')}>{nav[1]}</div>
                }
                {pathname === "/" ?
