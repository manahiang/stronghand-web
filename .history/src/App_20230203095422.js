            ...
            <div className='res'>
              <div className='navbar flex alige-item-center justify-content-evenly mt-3 navarr '>
                {pathname === "/" ?
                  ...
                  :
                  <Link to={"/"} style={{ marginTop: '20px' }}>{nav[0]}</Link>
                }
                {pathname === "/" ?
                  <AnchorLink href="#about"><div className='home'>{nav[1]}</div></AnchorLink>
                  :
                  <Link to={"/"} style={{ marginTop: '20px' }}>{nav[1]}</Link>
                }
                {pathname === "/" ?
                  <AnchorLink href="#product" ><div className='home' >{nav[2]}</div></AnchorLink>
                  :
                  <Link to={"/"} style={{ marginTop: '20px' }}>{nav[2]}</Link>
                }
                <Link to="/blog"><div className='home' >Blog</div></Link>
              </div>
            </div>
            <div className='menu'>
