          ...
          <div className='flex justify-content-between'>
            ...
            <div className='res'>
              <div className='navbar flex alige-item-center justify-content-evenly mt-3 navarr '>
                {pathname === "/" ?
                  <AnchorLink href="#solution"><div>{nav[0]}</div></AnchorLink>
                  :
                  <Link to={"/"} className='no-underline text-white text-xl font-bold mr-4' style={{ marginTop: '20px' }}>{nav[0]}</Link>
                }
                {pathname === "/" ?
                  <AnchorLink href="#about" className='no-underline text-white'><div className='home'>{nav[1]}</div></AnchorLink>
                  :
                  <Link to={"/"} className='no-underline text-white text-xl font-bold mr-4' style={{ marginTop: '20px' }}>{nav[1]}</Link>
                }
                {pathname === "/" ?
                  <AnchorLink href="#product" className='no-underline text-white text-xl font-bold mr-4' ><div className='home' >{nav[2]}</div></AnchorLink>
                  :
                  <Link to={"/"} className='no-underline text-white text-xl font-bold mr-4' style={{ marginTop: '20px' }}>{nav[2]}</Link>
                }
