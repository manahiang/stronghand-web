          ...
          <div className='flex justify-content-between'>
            ...
            <div className='menu'>
              <Sidebar visible={right} position="right"
                ...
                <AnchorLink href="#product" className='no-underline text-green-600 font-bold '><div className='home'>{nav[1]}</div></AnchorLink>

                <AnchorLink href="#about" className='no-underline text-green-600 '><div className='home'>{nav[2]}</div></AnchorLink>


                <Link to="/blog" className='no-underline text-green-600 font-bold '><div className='home'>blog</div></Link>
