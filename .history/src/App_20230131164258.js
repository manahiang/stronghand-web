            ...
            <div className='res'>
              <div className='navbar flex alige-item-center justify-content-evenly mt-3 navarr '>
                {pathname === "/" ?
                  ...
                  :<Link to={"/"} className='no-underline text-white text-2xl mt-3 font-bold'>{nav[0]}</Link>
                }
                {pathname === "/" ?
                  <AnchorLink href="#about" className='no-underline text-white'><div className='home'>{nav[1]}</div></AnchorLink> :<Link to={"/"} className='no-underline text-white text-2xl mt-3 font-bold'>{nav[0]}</Link>
