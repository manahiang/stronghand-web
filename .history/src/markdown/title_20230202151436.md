...
In *concurrentStart*, if promise *fast* rejects before promise *slow* is fulfilled, then an unhandled promise rejecttion error will be raised, regardless fo whether the caller hass configured a catch clu
