        ...
        <div className='header'>
          <div className='flex justify-content-between'>
            ...
            <div className='res'>
              <div className='navbar flex alige-item-center justify-content-evenly mt-3 navarr '>
                {pathname === "/" ?
                  ...
                  :
                  <Link to={"/"} className='no-underline text-white text-xl font-bold mr-2' style={{marginTop:'20px'}}>{nav[0]}</Link>
                }
                {pathname==="/"?:<AnchorLink href="#about" className='no-underline text-white'><div className='home'>{nav[1]}</div></AnchorLink><Link to{"/"}></Link>}
            ...
            <div className='menu'>
              ...
              <i className='m-6 text-xxl<AnchorLink href="#about" className='no-underline text-white'><div className='home'>{nav[1]}</div></AnchorLink> pi pi-th-large text-2xl text-white cursor-pointer' label='' onClick={() => setRight(true)}></i>
            </div>
            {/* Language */}
