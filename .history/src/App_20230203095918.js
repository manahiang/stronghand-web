          ...
          <div className='flex justify-content-between'>
            ...
            <div className='res'>
              <div className='navbar flex alige-item-center justify-content-evenly'>
                {pathname === "/" ?
                  <AnchorLink href="#solution" className='no-underline'><div>{nav[0]}</div></AnchorLink>
                  :
                  <Link to={"/"}><div>{nav[0]}</div></Link>
                }
                {pathname === "/" ?
                  <AnchorLink href="#about"><div>{nav[1]}</div></AnchorLink>
                  :
                  <Link to={"/"}><div>{nav[1]}</div></Link>
                }
                {pathname === "/" ?
                  <AnchorLink href="#product" ><div>{nav[2]}</div></AnchorLink>
                  :
                  <Link to={"/"}><div>{nav[2]}</div></Link>
                }
