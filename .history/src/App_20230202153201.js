            ...
            <div className='res'>
              <div className='navbar flex alige-item-center justify-content-evenly mt-3 navarr '>
                ...
                {pathname === "/" ?
                  ...
                  :
                  <Link to={"/"} className='no-underline text-white text-xl font-bold mr-2' style={{ marginTop: '20px' }}>{nav[1]}</Link>
                }
                {pathname === "/" ?
                  <AnchorLink href="#product" className='no-underline text-white' ><div className='home' >{nav[2]}</div></AnchorLink>
                  :
                  <Link to={"/"} className='no-underline text-white text-xl font-bold mr-2' style={{ marginTop: '20px' }}>{nav[2]}</Link>
                }
