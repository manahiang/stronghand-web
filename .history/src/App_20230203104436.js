            ...
            <div className='res'>
              <div className='navbar flex alige-item-center justify-content-evenly'>
                ...
                {pathname === "/" ?
                  ...
                  :
                  <div onClick={() => scrollToPage('about')} className='no-underline text-white'>{nav[1]}</div>
                }
                {pathname === "/" ?
                  <AnchorLink href="#product" className='no-underline text-white'><div >{nav[2]}</div></AnchorLink>
                  :
                  <div onClick={() => scrollToPage('product')} className='no-underline text-white'>{nav[2]}</div>
                }
            ...
            <div className='menu'>
              <Sidebar visible={right} position="right"
                ...
                {pathname === "/" ?
                  <AnchorLink
                    href="#solution"
                    className='no-underline text-green-600 font-bold
                transition-colors transition-duration-1000  hover:bg-yellow-500 text-green hover:text-gray-900
                flex justify-content-center  border-round
                '>
                    <div>{nav[0]}</div>
                  </AnchorLink>
                  :
                  <div onClick={() => scrollToPage('solution')} className='no-underline text-green-600 font-bold 
                  transition-colors transition-duration-1000  hover:bg-yellow-500 text-green hover:text-gray-900
                  flex justify-content-center border-round'>{nav[0]}</div>
                }
                {pathname === "/" ?
                  <AnchorLink href="#about" className='no-underline text-green-600 font-bold 
                transition-colors transition-duration-1000  hover:bg-yellow-500 text-green hover:text-gray-900
                flex justify-content-center border-round'><div className='home'>{nav[1]}</div></AnchorLink>
                  :
                  <div onClick={() => scrollToPage('product')} className='no-underline text-green-600 font-bold m-2
                  transition-colors transition-duration-1000  hover:bg-yellow-500 text-green hover:text-gray-900
                  flex justify-content-center border-round'>{nav[1]}</div>
                }
                {pathname === "/" ?
                  <AnchorLink href="#product" className='no-underline text-green-600 font-bold
                transition-colors transition-duration-1000  hover:bg-yellow-500 text-green hover:text-gray-900
                flex justify-content-center border-round'><div className='home'>{nav[2]}</div></AnchorLink>
                  :
                  <div onClick={() => scrollToPage('solution')} className='no-underline text-green-600 font-bold m-2
                  transition-colors transition-duration-1000  hover:bg-yellow-500 text-green hover:text-gray-900
                  flex justify-content-center  border-round'>{nav[2]}</div>
                }

                <Link to="/blog" className='no-underline text-green-600 font-bold
                transition-colors transition-duration-1000  hover:bg-yellow-500 text-green hover:text-gray-900
                flex justify-content-center border-round'><div className=''>blog</div></Link>
