...
function App() {
  ...
  const scrollToPage = async (target) => {
    if (navigates.location.pathname !=='/') {
      await navigates('/');
    }
    scrollTarget(target);
  };
          ...
          <div className='flex justify-content-between'>
            ...
            <div className='res'>
              <div className='navbar flex alige-item-center justify-content-evenly mt-3 navarr '>
                ...
                <AnchorLink =product" className='no-underline text-white' ><div className='home' >{nav[2]}</div></AnchorLink>
                onClick={() => scrollToPage('solution')}
