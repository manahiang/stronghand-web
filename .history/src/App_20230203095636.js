      ...
      <div className='container' id="container">
        ...
        <div className='header'>
          <div className='flex justify-content-between'>
            ...
            {/* navbar */}
            <div className='res'>
              <div className='flex alige-item-center justify-content-evenly mt-3 navarr '>
                {pathname === "/" ?
                ...
                {pathname === "/" ?
                  <AnchorLink href="#about"><div>{nav[1]}</div></AnchorLink>
                  :
                  <Link to={"/"} style={{ marginTop: '20px' }}>{nav[1]}</Link>
                }
                {pathname === "/" ?
                  <AnchorLink href="#product" ><div>{nav[2]}</div></AnchorLink>
                  :
