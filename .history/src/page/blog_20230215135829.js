                            ...
                            <div className='flex align-items-center justify-content-between mt-8 text-color'>
                                <div className='m-2'>
                                    <div className='flex align-items-center'>
                                        <Avatar image={item[0].en.profile.image}
                                            size='large' shape='circle' className='m-2' />
                                        <p className='name'>{item[0].en.profile.author}</p>
                                        <p className='name ml-2'>{item[0].en.profile.date}</p>
                                    ...
                                    <Link to={`blog-detail/${index}`} className='no-underline text-color'>
                                        <h1 className='title '>{item[0].en.headline.title}</h1>
                                ...
                                <img src={item[0].en.headline.pic} className='m-2 img' alt='pop' />
                            </div><hr />
                        </>
                    )}
