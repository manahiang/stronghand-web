                ...
                <div className='flex align-items-center justify-content-between mt-8 text-color'>
                    <div className='m-2'>
                        ...
                        <div className='flex align-items-center'>
                            <Avatar image={data.blog1.profile.image}
                                size='large' shape='circle' className='m-2' />
                            <p className='name'>{data.blog1.profile.author}</p>
                            <p className='name ml-2'>{data.blog1.profile.date}</p>
                            <i className='pi pi-star-fill ml-2' style={{ color: '#F2921D' }}></i>
                            <p className='ml-2 member'>Member-only</p>
                        </div>

                        <Link to='blog-detail' className='no-underline text-color'><h1 className='title '>{data.blog1.headline.title}</h1>
                            <p className='des font-bold mr-8 des'>
                                {data.blog1.headline.dec}</p></Link>
                        ...
                        <div className='flex align-items-center '>
                            ...
                            <div className="card flex justify-content-center">
                                <  model={items} popup ref={ell} onClick={(e) => ell.current.toggle(e)} />
                            </div>
                        </div>
                    </div>
                    <img src={data.blog1.headline.pic} className='m-2 img' alt='pop' />
                </div>
            )}
        </div>
    )
