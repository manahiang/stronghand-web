        ...
        <div className='container-blog text-white' style={{ maxWidth: '1200px', height: 'auto', margin: 'auto', marginTop: '100px' }}>
            <div className='flex align-items-center justify-content-between'>
                <div className=''>
                    ...
                    <p className='des font-weight-medium'>A small guide on creating the infamous “popup”
                    ...
                    <div className='flex align-items-center '>
                        ...
                        <p className='time-read ml-4'>6 min</p>
                        <p className='ml-4 font-bold'>read Based on your reading history</p>
                        <i className=' ml-3'></i>
