...
function BlogDetail() {
    ...
    return (
        ...
        <div className='blog_detail_container text-color' style={{ maxWidth: '1200px', height: 'auto', margin: 'auto' }}>
            <div className='flex align-items-center'>
                <Avatar image='https://pbs.twimg.com/profile_images/1564398871996174336/M-hffw5a_400x400.jpg'
                    size='xlarge' shape='circle' className='m-2 mt-8' />
                <div className='line-height-1'>
                    <p className='title text-xl'>Bill Gates</p>
                    <div className='flex align-items-center'>
                        <p>Nov 8,2023</p>
                        <p className='ml-2'>-</p>
