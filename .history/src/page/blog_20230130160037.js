        ...
        <div className='container-blog text-white ' style={{ maxWidth: '1200px', height: 'auto', margin: 'auto', marginTop: '100px' }}>
            ...
            <div className='flex align-items-center justify-content-between mt-8'>
                <div className='m-2'>
                    ...
                    <Link to='blog-detail' className='no-underline text-white'><h1 className='title '>10 Concepts to Improve Your Mastery of
                        JavaScript</h1>
            ...
            <div className='flex align-items-center justify-content-between mt-8'>
                ...
                <img src='https://miro.medium.com/fit/c/224/224/0*gL_ojV8R9rppK7ZL.png' className='w-2 m-2 img' alt='pop' />
            </div>
            <hr />
            ...
            <div className='flex align-items-center justify-content-between mt-8'>
                <div className='m-2'>
                    ...
                    <div className='flex align-items-center'>
                        <Avatar image='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTxmOgvs0vO-5Rsd9j4hwFfL8vc_QWTG5kG4w&usqp=CAU'
                            size='large' shape='circle' className='m-2 img' />
                        <p className='name'>Mark Zuckerberg</p>
                        <p className='name'>. Jul22,2023</p>
                        <i className='pi pi-star-fill ml-2' style={{ color: 'yellow' }}></i>
                        <p className='ml-2'>Member-only</p>
                    ...
                    <div className='flex align-items-center '>
                        ...
                        <Tooltip target=".custom-target-icon" />
                        <i className="custom-target-icon pi pi-bookmark  p-overlay-badge ml-3 boo"
                            data-pr-tooltip="Save"
                            data-pr-position="right"
                            data-pr-at="right+5 top"
                            data-pr-my="">
                ...
                <img src='https://miro.medium.com/fit/c/224/224/1*v6DWrSpGPYINJNHuFRrAIg.png' className='w-2 m-2 img' alt='pop' />
            </div>
            <hr />
        </div>
    )
