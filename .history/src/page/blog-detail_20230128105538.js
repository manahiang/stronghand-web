    ...
    return (
        <div className='blog_detail_container text-white' style={{ maxWidth: '1200px', height: 'auto', margin: 'auto', marginTop: '100px' }}>
            <div className='flex align-items-center '>
                ...
                <i className='pi pi-twitter ml-8 font-xxl'></i>
                <i className='pi pi-facebook ml-3'></i>
                <i className='pi pi-telegram ml-3'></i>
                <i className='pi pi-linkedin ml-3'></i>
                <i className='pi pi-link ml-3'></i>
                <i className='pi pi-bookmark ml-8'></i>
                <i className='pi pi-link ml-3'></i>
               
                
            </div>
            <h1 className='m-2 mt-4'>9 Awesome JavaScript Projects for your Resume</h1>
        </div>
    )
}
