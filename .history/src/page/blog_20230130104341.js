            ...
            <div className='flex align-items-center justify-content-between mt-8'>
                <div className='m-2'>
                    ...
                    <Link to='blog-detail' className='no-underline text-white'><h1 className='title '>How to Use Google Analytics on ReactJS in 5 Minutes</h1>
                        <p className='des font-bold mr-8'>
                        I’m sharing this guide on how to use Google Analytics with Universal Analytics property on ReactJS. A bit of introduction related with two products that we’re going to talk about: ReactJS is an SPA (Single Page</p></Link>
