...
function BlogDetail() {
    return (
        <div className='blog_detail_container text-white' style={{ maxWidth: '1200px', height: 'auto', margin: 'auto', marginTop: '100px' }}>
            ...
            <div>
                <p className=''>Let’s be honest right from the start. No matter how many books about programming you read, videos you watch, or podcasts you listen to, you must practice continuously if you want to become a better developer.
