        ...
        <div className='container-blog text-white ' style={{ maxWidth: '1200px', height: 'auto', margin: 'auto', marginTop: '100px' }}>
            ...
            <div className='flex align-items-center justify-content-between'>
                <div className='m-2'>
                    ...
                    <Link to='blog-detail' className='no-underline text-white'><h1 className='title'>How to create a Modal Component in React from basic to advanced?
                    </h1>
                        <p className='des font-bold mr-8'>At Auquan, we recently decided to redo our websites and optimize them for
                            the mobile view. Our aim was to do
                            some design changes for a</p></Link>
                ...
                <img src='https://miro.medium.com/freeze/fit/c/112/112/1*QC5IVFNUcoviMOe4mF5l1A.gif' className='w-3 m-2' alt='pop' />
            </div>
            <hr />
            ...
            <div className='flex align-items-center justify-content-between mt-8'>
                <div className='m-2'>
                    ...
                    <Link to='blog-detail' className='no-underline text-white'><h1 className='title '>9 Awesome JavaScript Projects for your Resume</h1>
                        <p className='des font-bold mr-8'>Build projects & get a high-paying developer job — If you want
                            ...
                            topics in a crisp & sharp way to skill you up! →</p></Link>
                ...
                <img src='https://miro.medium.com/fit/c/112/112/0*0Yu3JA_vjCwNjmXl' className='w-3 m-2' alt='pop' />
            </div>
            <hr />
            ...
            <div className='flex align-items-center justify-content-between mt-8'>
                <div className='m-2'>
                    ...
                    <Link to='blog-detail' className='no-underline text-white'><h1 className='title'>React Coding Interview Challenge 28</h1>
                        <p className='des font-bold mr-8'>Write a wrapper component that triggers a feedback popup — Hi, I’m Justin. I am an undergraduate
                            student studying computer science, and I started this series just before January 2022 to bridge a gap I</p></Link>
                ...
                <img src='https://miro.medium.com/fit/c/112/112/1*H9Fpy_7XbJDIhmA_ATxOng.png' className='w-3 m-2' alt='pop' />
            </div>
            <hr />
        </div>
    )
