...
function Blog() {
    ...
    return (
        ...
        <div className='surface-50'>
            ...
            {/* Add blog */}
            <Button label="Add blog" onClick={() => setVisible(true)} />
            <Dialog header="add blog" visible={visible} onHide={() => setVisible(false)}
                style={{ width: '50vw' }} breakpoints={{ '960px': '75vw', '641px': '100vw' }}>
                    <InputText type="text" placeholder="Enter your name" tooltip="Enter your username" className='p-2'/><br/>
                    <InputText type="text" placeholder="Enter your Title" tooltip="Enter your title" className='p-2'/><br/>
                    <InputText type="text" placeholder="Enter your description" tooltip="Enter your description" className='p-2'/>
            </Dialog>
