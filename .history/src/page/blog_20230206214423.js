                    ...
                    >
                        <div className='xl:flex sm:inline'>
                            <div className="card -mt-4">
                                <Avatar icon="pi pi-user" size="xlarge" className='mb-4' />
                            ...
                            <div className='p-2'><InputTextarea placeholder='Enter your description' value={value} onChange={(e) => 
                                setValue(e.target.value)} rows={5} cols={30} tooltip="enter your Description" /></div>
