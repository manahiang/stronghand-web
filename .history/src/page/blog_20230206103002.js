        ...
        <div className='surface-50'>
            ...
            <Dialog header="add blog" visible={visible} onHide={() => setVisible(false)}
                style={{ width: '50vw' }} breakpoints={{ '960px': '75vw', '641px': '100vw' }}>
                   <div className='flex justify-content-bet'>
                   <InputText type="text" placeholder="Enter your name" tooltip="Enter your username" />
                    <InputText type="text" placeholder="Enter your Title" tooltip="Enter your title" />
                    <InputText type="text" placeholder="Enter your description" tooltip="Enter your description" />
                   </div>
            </Dialog>
