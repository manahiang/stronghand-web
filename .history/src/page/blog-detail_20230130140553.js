    ...
    return (
        <div className='blog_detail_container text-white' style={{ maxWidth: '1200px', height: 'auto', margin: 'auto', marginTop: '100px' }}>
            ...
            <div className='flex align-items-center '>
                ...
                <a href={fb} className='text-white'><i className='pi pi-facebook ml-8 text-2xl'></i></a>
                <a href={telegram} className='text-white'><i className='pi pi-telegram ml-3 text-2xl'></i></a>
            ...
            <div style={{ width: '1200px',backgroundColor:'white'}} className="">
                <img src='https://miro.medium.com/v2/resize:fit:786/0*sk-gGCWt8ZrGY9z4' alt='' className='w-full m-2' />

                {/* markdown file */}

                <div className='m-2 mt-' style={{color:'black'}}>
                    <Markdown>
                        {title}
                    </Markdown>
                </div>
