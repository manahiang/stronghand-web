...

                {
                    data.data.map((item1)=>{
                        ...
                        <div className='flex align-items-center'>
                            <Avatar image={item1.profile.image}
                                size='xlarge' shape='circle' className='m-2' />
                            <div className='line-height-1 bill'>
                                <p className='title text-xl name1'>{item1.profile.author}</p>
                                <div className='flex align-items-center name2'>
                                    <p className='date'>{item1.profile.date}</p>
                        ...
                        <div className="m-3 mt-8">
                            <img src={item1.headline.markPic} alt='' className='w-full image border-round-md' />
