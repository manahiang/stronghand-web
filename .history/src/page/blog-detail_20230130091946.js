    ...
    return (
        <div className='blog_detail_container text-white' style={{ maxWidth: '1200px', height: 'auto', margin: 'auto', marginTop: '100px' }}>
            ...
            <div className='flex align-items-center '>
                ...
                <her to={fb} className='text-white'><i className='pi pi-facebook ml-8 text-2xl'></i></Link>
                <Link to={telegram} className='text-white'><i className='pi pi-telegram ml-3 text-2xl'></i></Link>
