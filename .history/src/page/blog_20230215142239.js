                            ...
                            <div className='flex align-items-center justify-content-between mt-8 text-color'>
                                <div className='m-2'>
                                    <div className='flex align-items-center'>
                                        <Avatar image={data.data.en.profile.image}
                                            size='large' shape='circle' className='m-2' />
                                        <p className='name'>{data.data.profile.author}</p>
                                        <p className='name ml-2'>{data.data.profile.date}</p>
                                    ...
                                    <Link to={`blog-detail/$`} className='no-underline text-color'>
                                        <h1 className='title '>{data.data.headline.title}</h1>
                                        <p className='des font-bold mr-8 des'>
                                            {data.data.headline.dec}</p></Link>
                                ...
                                <img src={data.data.en.headline.pic} className='m-2 img' alt='pop' />
                            </div><hr />
                        {/* </>
                    )} */}
