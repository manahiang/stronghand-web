                            ...
                            <div className='flex align-items-center justify-content-between mt-8 text-color'>
                                <div className='m-2'>
                                    <div className='flex align-items-center'>
                                        <Avatar image={item.profile[0]}
                                            size='large' shape='circle' className='m-2' />
                                        <p className='name'>{item.profile[1]}</p>
                                        <p className='name ml-2'>{item.profile[3]}</p>
                                    ...
                                    <Link to={`blog-detail/${index}`} className='no-underline text-color'>
                                        <h1 className='title '>{item.headline[0]}</h1>
                                        <p className='des font-bold mr-8 des'>
                                            {item.headline[1]}</p></Link>
                                ...
                                <img src={item.headline[3]} className='m-2 img' alt='pop' />
                            </div><hr />
                        </>
                    )}
