        ...
        <div className='surface-50'>
            ...
            <Dialog header="add blog" visible={visible} onHide={() => setVisible(false)}
                style={{ width: '50vw' }} breakpoints={{ '960px': '75vw', '641px': '100vw' }}>
                    ...
                    <InputText type="text" placeholder="Enter your Title" tooltip="Enter your username" />
                    <InputText type="text" placeholder="Enter your description" tooltip="Enter your username" />
            </Dialog>
