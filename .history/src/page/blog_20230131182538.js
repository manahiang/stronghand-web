            ...
            <div className='container-blog text-white ' style={{ maxWidth: '1200px', height: 'auto', margin: 'auto', paddingTop: '50px' }}>
                ...
                <div className='flex align-items-center justify-content-between mt-8 text-color'>
                    <div className='m-2'>
                        ...
                        <Link to='blog-detail' className='no-underline text-color'><h1 className='title '>11 Useful GitHub Repositories to Become a Pro React Developer</h1>
                            <p className='des font-bold mr-8 des'>
                                Awesome React GitHub repositories that every web developer should know in 2022. — Nowadays, the majority of new web developers are</p></Link>
