    ...
    return (
        ...
        <div className='blog_detail_container text-color pt-8' style={{ maxWidth: '1200px', height: 'auto', margin: 'auto' }}>
            ...
            <div className="m-3 mt-8">
                <img src='https://miro.medium.com/v2/resize:fit:786/0*sk-gGCWt8ZrGY9z4' alt='' className='w-full image' style={{borderRadius:'20px'}}/>

                {/* markdown file */}

                <div className='m-2 mt-8 text-color'>
                    <Markdown className="text-2xl line-height-3">
                        {title}
                    </Markdown>
                </div>
            </div>
