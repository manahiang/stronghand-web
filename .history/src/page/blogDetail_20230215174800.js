            ...
            <div style={{ backgroundColor: 'white' }}>
                ...
                <div className='blog_detail_container text-color pt-8' style={{ maxWidth: '1200px', height: 'auto', margin: 'auto' }}>
                    <div className='flex align-items-center'>
                        <Avatar image={data.data[id][_lan].profile.image}
                            size='xlarge' shape='circle' className='m-2' />
                        <div className='line-height-1 bill'>
                            <p className='title text-xl name1'>{data.data[id][_lan].profile.author}</p>
                            <div className='flex align-items-center name2'>
                                <p className='date'>{data.data[id][_lan].profile.date}</p>
                    ...
                    <h1 className='m-2 mt-4 font-bold'>{data.data[id][_lan].headline.title}</h1>
                    <h2 className='m-2 mt-4 font-normal'>{data.data[id][_lan].headline.dec}</h2>
                    <div className="m-3 mt-8">
                        <img src={data.data[id][_lan].headline.markPic} alt='' className='w-full image border-round-md' />
