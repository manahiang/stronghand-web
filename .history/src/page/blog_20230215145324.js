...
import data from "../language/test.json";
...
//   console.log(Language)
    ...
    //const r = data.data.map(item => item.en);
    //console.log(r);    
    // let _data = data;
    // console.log(data.data[0].en.profile);
    //console.log(_data.data[0].kh.profile)
                            ...
                            <div className='flex align-items-center justify-content-between mt-8 text-color'>
                                <div className='m-2'>
                                    ...
                                    <Link to={`blog-detail/${index}`} className='no-underline text-color'>
                                        <h1 className='title '>{item.headline.title}</h1>
