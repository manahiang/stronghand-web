    ...
    return (
        <div className='container-blog text-white' style={{ maxWidth: '1200px', height: 'auto', margin: 'auto', marginTop: '100px' }}>
            ...
            <div className='flex align-items-center justify-content-between'>
                ...
                <img src='https://miro.medium.com/freeze/fit/c/112/112/1*QC5IVFNUcoviMOe4mF5l1A.gif' className='w-4' alt='pop' />
            </div>
            <hr />
            ...
            <div className='flex align-items-center justify-content-between mt-8'>
                <div className=''>
                    ...
                    <div className='flex align-items-center'>
                        <Avatar image='https://upload.wikimedia.org/wikipedia/commons/1/18/Mark_Zuckerberg_
                        F8_2019_Keynote_%2832830578717%29_%28cropped%29.jpg'
                            size='large' shape='circle' className='m-2' />
                        <p className='name'>bill gates</p>
                        <p className='name'>. Jul22,2023</p>
                        <i className='pi pi-star-fill ml-2' style={{ color: 'yellow' }}></i>
                    ...
                    <h1 className='title'>Create A PopUp Window Using JS And React</h1>
                    <p className='des font-bold'>Build projects & get a high-paying developer job — If you want 
                    ...
                    <div className='flex align-items-center '>
                        ...
                        <Tooltip target=".custom-target-icon" />
                        <i className="custom-target-icon pi pi-bookmark  p-overlay-badge ml-4"
                            data-pr-tooltip="Save"
                            data-pr-position="right"
                            data-pr-at="right+5 top"
                            data-pr-my="">
                ...
                <img src='https://miro.medium.com/max/1400/0*0Yu3JA_vjCwNjmXl' className='w-3' alt='pop' />
            </div>
            <hr />
