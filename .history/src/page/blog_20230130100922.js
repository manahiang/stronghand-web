        ...
        <div className='container-blog text-white ' style={{ maxWidth: '1200px', height: 'auto', margin: 'auto', marginTop: '100px' }}>
            ...
            <div className='flex align-items-center justify-content-between'>
                <div className='m-2'>
                    ...
                    <Link to='blog-detail' className='no-underline text-white'><h1 className='title'>A Simple Carousel with Scroll Indicator in React using hooks
</h1>
                    <p className='des font-bold mr-8'>At Auquan, we recently decided to redo our websites and optimize them for the mobile view. Our aim was to do some design changes for a</p></Link>
