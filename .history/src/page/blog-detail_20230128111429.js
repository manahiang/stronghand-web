...
function BlogDetail() {
    return (
        <div className='blog_detail_container text-white' style={{ maxWidth: '1200px', height: 'auto', margin: 'auto', marginTop: '100px' }}>
            ...
            <div>
                <p style={{ width: '1000px' }} className="m-2">Let’s be honest right from the start. No matter how many books about programming
                 you read, videos you watch, or podcasts you listen to, you must practice continuously if you want to become a better developer.

                    In the front-end space, many frameworks exist — React, Angular, Vue, and Svelte, to name a few. Every single one of them 
                    is awesome; without them, front-end development wouldn’t be in its current state. But what those frameworks, besides all 
                    their differences, have in common is that they are all based on JavaScript. Yep, good ol’ JS!

                    JavaScript is what runs the web today, no doubt. And for every front-end developer, whether already experienced or at the 
                    start of their careers, it’s mandatory to know the basics of JavaScript, HTML, and CSS.

                    Frameworks come and go, but JavaScript will stay! But what’s the best way to practice JavaScript? The best answer I can give
                     you is to build projects!</p>
            </div>
