        ...
        <div className='container-blog text-white' style={{ maxWidth: '1200px', height: 'auto', margin: 'auto', marginTop: '100px' }}>
            ...
            <div className='flex align-items-center justify-content-between mt-8'>
                <div className=''>
                    ...
                    <h1 className='title'>Create A PopUp Window Using JS And React</h1>
                    <p className='des font-bold'>Build projects & get a high-paying developer job — If you want to learn more about tech, subscribe to my brand new YouTube Channel, where I explain complex topics in a crisp & sharp way to skill you up! →</p>
